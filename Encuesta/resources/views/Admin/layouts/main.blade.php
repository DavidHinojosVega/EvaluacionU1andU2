...
<html class="no-js h-100" lang="en">
  <head>
    ...
    color: white !important; /* El !important puede ser necesario para sobrescribir los estilos de Bootstrap si no funciona solo con 'color: white;' */
    opacity: 1; /* Esto asegura que el color no se atenúe, ya que algunos navegadores aplican una opacidad por defecto a los placeholders. */
}
    </style>
  </head>
  <body class="h-100 gradient-bg">
